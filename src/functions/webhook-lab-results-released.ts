...
const PWN_RESULTS_SCHEMA_ID = process.env.PWN_RESULTS_SCHEMA_ID;

const PWN_RESULTS_VAULT_ID = process.env.PWN_RESULTS_VAULT_D;
    ...
    if (data.result === "Normal") {
      try {
        ...
        await pwnTrueVaultClient.sendEmailSendgrid(
          ...
          target_user_id,
          "25d5583c-d763-47da-afd4-0842632c6570", // template id
